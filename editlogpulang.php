<?php
  ...
  $id = $_GET['id'];
  $sql = mysqli_query($link,"SELECT * FROM demo_log_keluar WHERE data='$id'");

  while($d = mysqli_fetch_array($sql)){
 ?>

  <div class="container">
    <form method="post" action="perbaruilogpulang.php">
      ...
      <div class="form-group row">
        <div class="col-sm-offset-2 col-sm-10">
          <a href="<?php echo $base_path?>index.php?action=log_pulang" class="btn btn-default">Back</a>
